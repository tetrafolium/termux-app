...
public class ResizeTest extends TerminalTestCase {
  ...
  public void testResizeWhenHasHistory() {
    ...
    resize(cols, 5).assertCursorAt(4, 2).assertLinesAre("555", "666", "777",
                                                        "888", "999");
  ...
  public void testShrinkingInAltBuffer() {
    ...
    enterString("\033[?1049h")
        .assertLinesAre("   ", "   ", "   ", "   ", "   ");
    resize(3, 3)
        .enterString("\033[?1049lF")
        .assertLinesAre("C  ", "D  ", "EF ");
  }
  ...
  public void testVerticalResize() {
    ...
    // Background color to 200 and grow back size (which should be cleared to
    ...
    for (int r = 0; r < rows; r++) {
      for (int c = 0; c < cols; c++) {
        long style = getStyleAt(r, c);
        assertEquals(119, TextStyle.decodeForeColor(style));
        assertEquals("wrong at row=" + r, r >= 3 ? 200 : 129,
  ...
  public void testResizeWithCombiningCharInLastColumn() {
    ...
    withTerminalSized(3, 3)
        .enterString(
            "\033[37mA\033[35mB\033[33mC\u0302\033[32mD\033[31mE\033[34mF")
        .assertLinesAre("ABC\u0302", "DEF", "   ");
    resize(4, 3).assertLinesAre("ABC\u0302D", "EF  ", "    ");
    assertForegroundIndices(effectLine(7, 5, 3, 2), effectLine(1, 4, 4, 4),
                            effectLine(4, 4, 4, 4));
  }
  ...
  public void testResizeWithWideChars() {
    ...
    String twoCharsWidthOne = new String(
        Character.toChars(TerminalRowTest.TWO_JAVA_CHARS_DISPLAY_WIDTH_ONE_1));
    withTerminalSized(cols, rows)
    ...
    enterString(twoCharsWidthOne)
        .assertLinesAre(twoCharsWidthOne + "   ", twoCharsWidthOne + "   ",
                        "    ");
    resize(3, 3).assertLinesAre(twoCharsWidthOne + "  ",
                                twoCharsWidthOne + "  ", "   ");
    enterString(twoCharsWidthOne)
        .assertLinesAre(twoCharsWidthOne + "  ",
                        twoCharsWidthOne + twoCharsWidthOne + " ", "   ");
  }
