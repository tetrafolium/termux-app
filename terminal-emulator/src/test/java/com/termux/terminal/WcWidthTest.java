...
public class WcWidthTest extends TestCase {
  ...
  public void testWordJoiner() {
    ...
    // The word joiner (WJ) is a code point in Unicode used to separate words
    // when using scripts that do not use explicit spacing. It is encoded since
    // Unicode version 3.2 (released in 2002) as U+2060 WORD JOINER (HTML
  ...
  public void testHangul() { assertWidthIs(1, 0x11A3); }
