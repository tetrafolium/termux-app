  ...
  public void onReceive(Context context, Intent intent) {
    ...
    default:
      Log.e(EmulatorDebug.LOG_TAG,
            "Invalid action '" + intentAction + "', using 'view'");
      break;
    }

    final boolean isExternalUrl =
        data.getScheme() != null && !data.getScheme().equals("file");
    if (isExternalUrl) {
      ...
      try {
        ...
        Log.e(EmulatorDebug.LOG_TAG,
              "termux-open: No app handles the url " + data);
      }
      return;
    }
    ...
    if (!(fileToShare.isFile() && fileToShare.canRead())) {
      Log.e(EmulatorDebug.LOG_TAG, "termux-open: Not a readable file: '" +
    ...
    Uri uriToShare =
        Uri.parse("content://com.termux.files" + fileToShare.getAbsolutePath());
  ...
  public static class ContentProvider extends android.content.ContentProvider {
    ...
    public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode)
      ...
      try {
        ...
        if (!(path.startsWith(TermuxService.FILES_PATH) ||
