...
public void testCsiS() {
	// The behaviour here is a bit inconsistent between terminals - this is how
	// the OS X Terminal.app does it:
...
public void testCsiX() {
	// See https://code.google.com/p/chromium/issues/detail?id=212712 where test
	// was extraced from.
...
public void testCsiSGRParameters() {
	// Set more parameters (19) than supported (16).  Additional parameters
...
public void testRepeat() {
	...
	// This shows that REP outputs the last emitted code point and not the one
...
public void testCsi3J() {
	...
	withTerminalSized(3, 2).enterString(
