...
public final class DialogUtils {
  ...
  public interface TextSetListener { void onTextSet(String text); }

  public static void
  textInput(Activity activity, int titleText, String initialText,
    ...
    input.setImeActionLabel(
        activity.getResources().getString(positiveButtonText),
    ...
    layout.setPadding(paddingTopAndSides, paddingTopAndSides,
                      paddingTopAndSides, paddingBottom);
