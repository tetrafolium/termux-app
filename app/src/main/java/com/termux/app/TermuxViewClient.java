...
public final class TermuxViewClient implements TerminalViewClient {
  ...
  /**
   * Keeping track of the special keys acting as Ctrl and Fn for the soft
  ...
  public void onSingleTapUp(MotionEvent e) {
    InputMethodManager mgr = (InputMethodManager)mActivity.getSystemService(
        Context.INPUT_METHOD_SERVICE);
    mgr.showSoftInput(mActivity.mTerminalView,
  ...
  public void copyModeChanged(boolean copyMode) {
    ...
    mActivity.getDrawer().setDrawerLockMode(
        copyMode ? DrawerLayout.LOCK_MODE_LOCKED_CLOSED
    ...
    if (keyCode == KeyEvent.KEYCODE_ENTER && !currentSession.isRunning()) {
      ...
      if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN ||
        ...
        mActivity.doPaste();
                 ...
                 e.getUnicodeChar(KeyEvent.META_SHIFT_ON) == '+') {
        // We also check for the shifted char here since shift may be required
        // to produce '+', see https://github.com/termux/termux-api/issues/2
  ...
  public boolean readControlKey() {
    return (mActivity.mExtraKeysView != null &&
            mActivity.mExtraKeysView.readSpecialButton(
                ExtraKeysView.SpecialButton.CTRL)) ||
  ...
  public boolean readAltKey() {
    return (mActivity.mExtraKeysView != null &&
            mActivity.mExtraKeysView.readSpecialButton(
                ExtraKeysView.SpecialButton.ALT));
  }

  @Override
  public boolean onCodePoint(final int codePoint, boolean ctrlDown,
    ...
    if (mVirtualFnKeyDown) {
      ...
      List<TermuxPreferences.KeyboardShortcut> shortcuts =
          mActivity.mSettings.shortcuts;
