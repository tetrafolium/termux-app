...
final class GestureAndScaleRecognizer {
  ...
  public void onTouchEvent(MotionEvent event) {
    ...
    case MotionEvent.ACTION_UP:
      if (!isAfterLongPress) {
        // This behaviour is desired when in e.g. vim with mouse events, where
        // we do not want to move the cursor when lifting finger after a long
        // press.
  ...
  public boolean isInProgress() { return mScaleDetector.isInProgress(); }
}
